...
contract Blog is Initializable, IBlog, ERC165Upgradeable, ERC1155Upgradeable, ERC1155SupplyUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function mintPremium(string calldata tokenURI) public payable virtual whenNotPaused nonReentrant {
